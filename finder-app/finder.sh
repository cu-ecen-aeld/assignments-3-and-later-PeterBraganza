#!/bin/sh
#References: 1. https://www.cyberciti.biz/faq/grep-count-lines-if-a-string-word-matches/
...
#find the total number of files within a directory and subdirectories
